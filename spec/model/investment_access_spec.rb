...
describe InvestmentAccess do
  ...
  it 'creates a new investment' do
    DatabaseCleaner.cleaning do
      InvestmentAccess.create(name: 'Investment Name', symbol: 'ABC', asset: true, term: 'short')
  ...
  it 'creates two new investments' do
    DatabaseCleaner.cleaning do
      InvestmentAccess.create(name: 'Investment Name 1', symbol: 'CASHX', asset: true, term: 'short')
      InvestmentAccess.create(name: 'Investment Name 2', symbol: 'PG', asset: false, term: 'short')
      expect(InvestmentAccess.all.length).to eq 2
    end
  end

  it 'sets the name of the investment' do
    DatabaseCleaner.cleaning do
      InvestmentAccess.create(name: 'Investment Name', symbol: 'CASHX', asset: true, term: 'short')
  ...
  it 'enforces a non-null name for the investment' do
    DatabaseCleaner.cleaning do
      expect{ InvestmentAccess.create(symbol: 'CASHX', asset: true, term: 'short') }.to raise_error Sequel::NotNullConstraintViolation
    end
  end

  it 'sets the symbol of the investment' do
    DatabaseCleaner.cleaning do
      InvestmentAccess.create(name: 'Investment Name', symbol: 'CASHX', asset: false, term: 'short')
      investment = InvestmentAccess.first
  ...
  it 'sets the asset of the investment to true' do
    DatabaseCleaner.cleaning do
      InvestmentAccess.create(name: 'Investment Name', symbol: 'CASHX', asset: true)
      investment = InvestmentAccess.first
  ...
  it 'sets the asset of the investment to false' do
    DatabaseCleaner.cleaning do
      InvestmentAccess.create(name: 'Investment Name', symbol: 'CASHX', asset: false)
      investment = InvestmentAccess.first
  ...
  it 'sets the term of the investment to medium' do
    DatabaseCleaner.cleaning do
      InvestmentAccess.create(name: 'Investment Name', symbol: 'CASHX', asset: false, term: 'medium')
      investment = InvestmentAccess.first
  ...
  it 'does not set an invesetment term with a random value' do
    DatabaseCleaner.cleaning do
      expect{InvestmentAccess.create(name: 'Investment Name', symbol: 'CASHX', asset: false, term: 'foobar')}.to raise_error Sequel::CheckConstraintViolation
    end
  end
  ...
  it 'sets the date an investment was closed' do
    DatabaseCleaner.cleaning do
      InvestmentAccess.create(name: 'Investment Name', symbol: 'CASHX', asset: false, close_date: Date.new(2012,2,3))
      investment = InvestmentAccess.first
  ...
  it 'sets both an open and close date' do
    DatabaseCleaner.cleaning do
      InvestmentAccess.create(name: 'Investment Name', symbol: 'CASHX', asset: false, open_date: Date.new(2010,1,1), close_date: Date.new(2012,2,3))
      investment = InvestmentAccess.first
  ...
  it 'the close date cannot occur before the open date' do
    DatabaseCleaner.cleaning do
      expect{InvestmentAccess.create(name: 'Investment Name', symbol: 'CASHX', asset: false, open_date: Date.new(2012,2,8), close_date: Date.new(2012,2,3))}.to raise_error Sequel::CheckConstraintViolation
    end
  end

  it 'enforces a non-null asset for the investment' do
    DatabaseCleaner.cleaning do
      expect{ InvestmentAccess.create(name: 'Investment Name', symbol: 'CASHX', term: 'short') }.to raise_error Sequel::NotNullConstraintViolation
    end
  end

  it 'sets the created_at timestamp' do
    DatabaseCleaner.cleaning do
      InvestmentAccess.create(name: 'Investment Name 1', symbol: 'CASHX', asset: false)
      investment = InvestmentAccess.first
  ...
  it 'sets the updated_at timestamp at creation' do
    DatabaseCleaner.cleaning do
      InvestmentAccess.create(name: 'Investment Name 1', symbol: 'CASHX', asset: true)
      investment = InvestmentAccess.first
  ...
  it 'has an account as a parent' do
    DatabaseCleaner.cleaning do
      ...
      account = AccountAccess.create(name: 'Investment Name 1', owner: 'Bob', institution_id: institution[:id])
      investment = InvestmentAccess.create(name: 'Investment Name 1', symbol: 'CASHX', asset: true, account_id: account[:id])
